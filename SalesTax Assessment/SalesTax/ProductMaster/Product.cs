...
{
    //Abstract Factory - Concrete Implenentations are available in dderieved class
    public abstract class Product
    {
        // Each type of product has these information in general in perspective of the shop
